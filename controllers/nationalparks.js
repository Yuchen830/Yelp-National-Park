...
//routes for add new park page
module.exports.newForm = (req, res) => {
    res.render('nationalparks/new');
}

// routes for create new park
module.exports.createPark = async (req, res, next) => {
    //if (!req.body.nationalpark) throw new ExpressError('Invalid National Park Data', 400);
    ...
    req.flash('success', 'Successfully created a new national park!');
    res.redirect(`/nationalparks/${nationalpark._id}`)
}

//route for show specific park card
...
module.exports.updatePark =  async (req, res) => {
    ...
    req.flash('success', 'Successfully updated a national park!');
    res.redirect(`/nationalparks/${nationalpark.id}`)
}
